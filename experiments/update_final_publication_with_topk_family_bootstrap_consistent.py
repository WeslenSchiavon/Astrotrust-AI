...
# -*- coding: utf-8 -*-
r"""
update_final_publication_with_topk_family_bootstrap_consistent.py
...
Uso:
python .\experiments\update_final_publication_with_topk_family_bootstrap_consistent.py `
  --topk-family-dir results\topk_family_bootstrap_ci_250k_consistent_final `
...
def main() -> None:
    ...
    parser.add_argument("--topk-family-dir", default="results/topk_family_bootstrap_ci_250k_consistent_final")
...
""".strip() + "\n"
    ...
    if re.search(pattern, text, flags=re.S):
        updated = re.sub(pattern, lambda _m: new_section, text, flags=re.S)
    else:
        updated = text.rstrip() + "\n\n" + new_section
