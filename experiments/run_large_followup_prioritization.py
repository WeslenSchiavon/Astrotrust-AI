...
RESULTS_ROOT = ROOT_DIR / "results" / "large_followup_prioritization"
...
def main():
    ...
    # Rare classes: bottom quartile by class frequency.
    class_counts = pd.Series(y).value_counts()
    rare_threshold = class_counts.quantile(0.25)
    ...
    rarity_score = compute_rarity_weights(y_train, y_pred)
