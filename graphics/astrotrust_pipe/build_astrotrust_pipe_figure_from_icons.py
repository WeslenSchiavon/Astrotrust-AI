...
# -*- coding: utf-8 -*-
"""
Generate a publication-ready conceptual AstroTrust-AI pipeline figure.
...
Default output:
  results/final_publication/figures/astrotrust_ai_pipeline_concept.png
"""
...
BASE_DIR = ROOT_DIR
ICONS_DIR = BASE_DIR / 'graphics/astrotrust_pipe/02_transparent_background_png'
OUTPUT_PNG = ROOT_DIR / Path('results/final_publication/figures/astrotrust_rebuilt_from_icons_v2.png')
ASSET_ROOT = ICONS_DIR.parent
...
def build_figure(asset_root: Path, output_png: Path) -> None:
    ...
    center_text(
        ...
        W // 2,
        10,
        "AstroTrust-AI: from light-curve ingestion to broker-like decision support",
        TITLE_FONT,
        NAVY,
        spacing=4,
    )
   ...
   # Card 1 geometry
    ...
    draw.text((780, 229), "Predictive inference", font=STEP_TITLE_FONT, fill=BLUE)
    draw_multiline(
        draw,
        (729, 275),
    ...
    draw_multiline(
        ...
        "flag fragile cases.\n"
        "Calibration improves probabilistic\n"
        "interpretability.\n"
        "Domain checks warn about out-of-\n"
        "distribution inputs.",
        LOWER_BODY_FONT,
        BOX_TEXT,
        spacing=5,
    ...
    draw_multiline(
        draw,
        (1245, 693),
        "Candidates are ranked using calibrated\n"
        "evidence.\n"
